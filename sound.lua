...
function ZergSound.ultralisk_attack(volume)
    return
    {
        ...
        variations = {
            {
                filename = "__erm_zerg__/sound/enemies/ultralisk/attack0.ogg",
                volume = volume
            },
            {
                filename = "__erm_zerg__/sound/enemies/ultralisk/attack1.ogg",
                volume = volume
            },
            {
                filename = "__erm_zerg__/sound/enemies/ultralisk/attack2.ogg",
                volume = volume
            },
            {
                filename = "__erm_zerg__/sound/enemies/ultralisk/attack3.ogg",
                volume = volume
            }
        }
    }
...
function ZergSound.queen_snare(volume)
    return
    {
        ...
        filename = "__erm_zerg_high_res__/sound/enemies/queen/snare.ogg",
        volume = volume
    }
end
...
function ZergSound.queen_attack(volume)
    return
    {
        ...
        filename = "__erm_zerg_high_res__/sound/enemies/queen/attack.ogg",
        volume = volume
    }
end
